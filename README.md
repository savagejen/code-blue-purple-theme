...
Open this folder in VS Code and press `F5`: it launches an Extension
...
1. Clone this repository:
   ...
   ```bash
   git clone <repo-url> code-blue-purple-theme
   ```
...
2. Symlink or copy the folder into your extensions directory. A symlink
   ...
   ln -s "$PWD/code-blue-purple-theme" ~/.vscode/extensions/code-blue-purple-theme

   # Or copy
   cp -r ./code-blue-purple-theme ~/.vscode/extensions/code-blue-purple-theme
   ```
